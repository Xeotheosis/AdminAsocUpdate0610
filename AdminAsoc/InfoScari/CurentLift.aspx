<%@ Page Title="" Language="C#" Async="true"  MasterPageFile="~/AdminAsoc/AdminAssociationMaster.Master" AutoEventWireup="true" CodeBehind="CurentLift.aspx.cs" Inherits="WebAppNet472.CurentLift" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <h3 class="text-5xl text-white font-bold">Energie Lift</h3>
       ...
       <p class="text-4xl text-white">RON</p>
        ...
        <asp:GridView ID="gvFact"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Valoare" DataField="cpp3val" ControlStyle-CssClass="editable-field " />
